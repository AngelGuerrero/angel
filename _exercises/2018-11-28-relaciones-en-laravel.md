...
![]({{ site.baseurl }}{{ page.images }}/class_model.png){: style="max-width: 300px" }
...
![]({{ site.baseurl }}{{ page.images }}/er_model.PNG)
...
![]({{ site.baseurl }}{{ page.images }}/cambiando rama.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/conectando vagrant.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/creando modelo persona.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/codigo migracion persona.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/creando modelo user.JPG)

Para la relación de uno a uno se le crea la llave foránea para la tabla de users
, de la siguiente forma:

![]({{ site.baseurl }}{{ page.images }}/codigo migracion user.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/codigo modelo persona has one user.png)
...
![]({{ site.baseurl }}{{ page.images }}/modelo user belongsto person.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/first migrate.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/tinker asociacion usuario persona firstname.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/migracion creando post.JPG)

El código para la migración del Post
 quedaría de la siguiente forma:

![]({{ site.baseurl }}{{ page.images }}/codigo migracion post.JPG)

El código para el modelo de User
 sería el siguiente.

![]({{ site.baseurl }}{{ page.images }}/codigo migracion post relacion usuario.JPG)

Código de modelo Post

![]({{ site.baseurl }}{{ page.images }}/codigo modelo post belongs to user.JPG)

Realización de las migraciones

![]({{ site.baseurl }}{{ page.images }}/ejecutando migraciones posts.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/tinker creacion post fallido.JPG)

![]({{ site.baseurl }}{{ page.images }}/tinker creacion post exitoso.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/tinker recuperando datos del post y sus asociaciones.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/blade welcome posts.JPG)
...
![]({{ site.baseurl }}{{ page.images }}/rutas lista posts.JPG)

Para ver el resultado es necesario volver a acceder desde el navegador para ver el resultado.

![]({{ site.baseurl }}{{ page.images }}/navegador lista de posts.JPG)
