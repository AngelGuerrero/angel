...
/*!*************************!*\
  !*** ./src/MyTypeIt.js ***!
  \*************************/
/*! exports provided: executeTypeIt */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"executeTypeIt\", function() { return executeTypeIt; });\n/* harmony import */ var typeit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! typeit */ \"./node_modules/typeit/dist/typeit.es.min.js\");\n\nvar pausetime = 1000;\nvar class__wrapper = \".type__presentation\";\nvar tag = \"strong\";\nvar classes = [\"presentation_item\"];\n\nvar wrapper = function wrapper(data, newLine) {\n  return \"<\".concat(tag, \" class=\\\"\").concat(classes.toString(), \"\\\">\") + data + \"</\".concat(tag, \"> \").concat(newLine ? \"<br>\" : \"\");\n};\n\nvar executeTypeIt = function executeTypeIt() {\n  new typeit__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\".type__branding\", {\n    strings: [\"Hi,<br>my name is<br>Ángel Guerrero\"],\n    speed: 90,\n    breakLines: false,\n    waitUntilVisible: true\n  }).go();\n  new typeit__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\".type__presentation\", {\n    delay: 500,\n    strings: [\"<strong>I develop in...</strong>\\n\", \"\\n\"],\n    speed: 50\n  }).pause(pausetime).type(wrapper(\"Vue\", true)).pause(pausetime).type(wrapper(\"C#\", true)).pause(pausetime).type(wrapper(\"SQL Server\", true)).pause(pausetime).type(wrapper(\"DevExpress\", true)).pause(pausetime).type(wrapper(\"DevExtreme\", true)).pause(pausetime).type(wrapper(\"Node\", true)).pause(pausetime).type(wrapper(\"JavaFX\")).pause(pausetime)[\"delete\"](7).type(wrapper(\"PHP\")).pause(pausetime)[\"delete\"](4).type(wrapper(\"SQL\")).pause(pausetime)[\"delete\"](4).type(wrapper(\"PL/SQL\")).pause(pausetime)[\"delete\"](7).type(wrapper(\"SASS\", true)).pause(pausetime).type(wrapper(\"JavaScript\", true)).pause(pausetime).type(wrapper(\"Jekyll\")).pause(pausetime)[\"delete\"](7).type(wrapper(\"Git\")).pause(pausetime)[\"delete\"](4).type(wrapper(\"Express\")).pause(pausetime).go();\n};\n\n//# sourceURL=webpack:///./src/MyTypeIt.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _MyTypeIt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MyTypeIt */ \"./src/MyTypeIt.js\");\n\nObject(_MyTypeIt__WEBPACK_IMPORTED_MODULE_0__[\"executeTypeIt\"])();\n\n//# sourceURL=webpack:///./src/main.js?");
