...
<a href="{{ site.baseurl }}{{ page.image_dir }}/express_start.png" alt="Servidor corriendod"><img src="{{ site.baseurl }}{{ page.image_dir }}/express_start.png" alt="Servidor corriendod"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/hello_world.PNG" alt="Hola_mundod"><img src="{{ site.baseurl }}{{ page.image_dir }}/hello_world.PNG" alt="Hola_mundod"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/unresolve_response.PNG" alt="unresolve_responsed"><img src="{{ site.baseurl }}{{ page.image_dir }}/unresolve_response.PNG" alt="unresolve_responsed"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/hello_world_express.PNG" alt="hello_world_expressd"><img src="{{ site.baseurl }}{{ page.image_dir }}/hello_world_express.PNG" alt="hello_world_expressd"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/students_json.PNG" alt="students_jsond"><img src="{{ site.baseurl }}{{ page.image_dir }}/students_json.PNG" alt="students_jsond"></a>

Respuesta de `api/v1/careers`

<a href="{{ site.baseurl }}{{ page.image_dir }}/careers_json.PNG" alt="careers_jsond"><img src="{{ site.baseurl }}{{ page.image_dir }}/careers_json.PNG" alt="careers_jsond"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/parameter_browser_log.PNG" alt="parameter_browser_logd"><img src="{{ site.baseurl }}{{ page.image_dir }}/parameter_browser_log.PNG" alt="parameter_browser_logd"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/parameter_terminal_log.PNG" alt="parameter_terminal_logd"><img src="{{ site.baseurl }}{{ page.image_dir }}/parameter_terminal_log.PNG" alt="parameter_terminal_logd"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/student_one_json.PNG" alt="student_one_jsond"><img src="{{ site.baseurl }}{{ page.image_dir }}/student_one_json.PNG" alt="student_one_jsond"></a>

Mas sin embargo si se busca un elemento que no existe se obtiene el siguiente mensaje.
<a href="{{ site.baseurl }}{{ page.image_dir }}/student_four_json.PNG" alt="student_four_jsond"><img src="{{ site.baseurl }}{{ page.image_dir }}/student_four_json.PNG" alt="student_four_jsond"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/students_init_get_postman.PNG" alt="students_init_get_postmand"><img src="{{ site.baseurl }}{{ page.image_dir }}/students_init_get_postman.PNG" alt="students_init_get_postmand"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/students_first_new_postman.PNG" alt="students_first_new_postmand"><img src="{{ site.baseurl }}{{ page.image_dir }}/students_first_new_postman.PNG" alt="students_first_new_postmand"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/students_after_get_postman.PNG" alt="students_after_get_postmand"><img src="{{ site.baseurl }}{{ page.image_dir }}/students_after_get_postman.PNG" alt="students_after_get_postmand"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/student_second_post.PNG" alt="student_second_postd"><img src="{{ site.baseurl }}{{ page.image_dir }}/student_second_post.PNG" alt="student_second_postd"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/registro_mlab.PNG" alt="registro_mlabd"><img src="{{ site.baseurl }}{{ page.image_dir }}/registro_mlab.PNG" alt="registro_mlabd"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/datos_db_mongo.PNG" alt="datos_db_mongod"><img src="{{ site.baseurl }}{{ page.image_dir }}/datos_db_mongo.PNG" alt="datos_db_mongod"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/nuevo_objeto_mlab.PNG" alt="nuevo_objeto_mlabd"><img src="{{ site.baseurl }}{{ page.image_dir }}/nuevo_objeto_mlab.PNG" alt="nuevo_objeto_mlabd"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/mlab_primer_objeto.PNG" alt="mlab_primer_objetod"><img src="{{ site.baseurl }}{{ page.image_dir }}/mlab_primer_objeto.PNG" alt="mlab_primer_objetod"></a>
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/datos_antes_editar.PNG"><img src="{{ site.baseurl }}{{ page.image_dir }}/datos_antes_editar.PNG" alt="datos_antes_editar"></a>

Si se envía una petición de tipo PUT para editar ese objeto, se obtiene el objeto modificado.

<a href="{{ site.baseurl }}{{ page.image_dir }}/respuesta_editar.PNG"><img src="{{ site.baseurl }}{{ page.image_dir }}/respuesta_editar.PNG" alt="respuesta_editar"></a>
---
...
<a href="{{ site.baseurl }}{{ page.image_dir }}/respuesta_borrar.PNG"><img src="{{ site.baseurl }}{{ page.image_dir }}/respuesta_borrar.PNG" alt="respuesta_borrar"></a>
